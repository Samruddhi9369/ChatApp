...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private TextView textDeviceListPairedDeviceTitle, textDeviceListNewDeviceTitle;
    ...
    private void getWidgetReferences() {
        ...
        textDeviceListPairedDeviceTitle = (TextView) findViewById(R.id.textDeviceListPairedDeviceTitle);
        textDeviceListNewDeviceTitle = (TextView) findViewById(R.id.textDeviceListNewDeviceTitle);
    ...
    private void initializeValues() {
        ...
        if (pairedDevices.size() > 0) {
            textDeviceListPairedDeviceTitle.setVisibility(View.VISIBLE);
    ...
    private void startDiscovery() {
        ...
        textDeviceListNewDeviceTitle.setVisibility(View.VISIBLE);
